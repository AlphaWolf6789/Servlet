...
public class CalculatorServiceLocator extends org.apache.axis.client.Service implements com.demo.CalculatorService {
    ...
    private java.lang.String Calculator_address = "http://localhost:8080/HelloWorldWS/services/Calculator";
    ...
    public com.demo.Calculator getCalculator(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.demo.CalculatorSoapBindingStub _stub = new com.demo.CalculatorSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.demo.Calculator.class.isAssignableFrom(serviceEndpointInterface)) {
                com.demo.CalculatorSoapBindingStub _stub = new com.demo.CalculatorSoapBindingStub(new java.net.URL(Calculator_address), this);
                _stub.setPortName(getCalculatorWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://demo.ws.bkacad.com", "CalculatorService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://demo.ws.bkacad.com", "Calculator"));
        }
